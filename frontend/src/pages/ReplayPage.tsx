          ...
          {gameInfo && (
            <div className="flex items-center gap-8 text-sm">
              <div className="flex items-center gap-2">
                ...
                <span>{typeof gameInfo.player1.username === 'string' ? gameInfo.player1.username : (gameInfo.player1 as any).username} ({gameInfo.player1.rating ? Math.round(gameInfo.player1.rating) : '?'})</span>
              </div>
              <div className="text-gray-600">VS</div>
              <div className="flex items-center gap-2">
                <span>{typeof gameInfo.player2.username === 'string' ? gameInfo.player2.username : (gameInfo.player2 as any).username} ({gameInfo.player2.rating ? Math.round(gameInfo.player2.rating) : '?'})</span>
